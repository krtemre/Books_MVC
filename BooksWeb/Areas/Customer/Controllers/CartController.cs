...
namespace BooksWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            {
                cart.Product.ProductImages = productImages.Where(s => s.ProductId == cart.ProductId).ToList();
        ...
        public IActionResult Minus(int cartId)
        {
            ...
            {
                HttpContext.Session.SetInt32(SD.SessionCart, _unitOfWork.ShoppingCart.GetAll(s => s.ApplicationUserId == cartFromDb.ApplicationUserId).Count() - 1);
